...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#") {
        ...
        TransferLogRecord.scrBalanceAfter = stod(vTransferLogRecordLine[4]);
    ...
    void _RegisterTransferLog(float Amount, clsBankClient DestinationClient, string UserName) {
        ...
        fstream MyFile;
        MyFile.open("TransferLog100.txt", ios::out || ios::app);
        if (MyFile.is_open()) {
...
public:
    ...
    static vector <stTransferLogRecord> GetTransferLogist() {

        vector <stTransferLogRecord> vTransferLogRecord;
        fstream MyFile;
        MyFile.open("TransferLog100.txt", ios::in);
        if (MyFile.is_open()) {


            string Line;
            stTransferLogRecord TransfRecord;
            while (getline(MyFile, Line)) {
                TransfRecord = _ConvertTransferLogLineToRecord(Line);
                vTransferLogRecord.push_back(TransfRecord);
