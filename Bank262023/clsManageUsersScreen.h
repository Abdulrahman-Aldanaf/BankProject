...
private:
	enum enManageUsersMenueOptions {
		elistUsera = 1, eAddNewUser = 2, eDeleteUser = 3, eUpdateUser = 4, eFindUser = 5, eMainMenue = 6
	};
...
static void _PerformManageUsersMenueOption(enManageUsersMenueOptions ManageUsersMenueOption) {
	...
	{
	case enManageUsersMenueOptions::elistUsera:
	{
		system("cls");
...
public :
	...
	static void ShowManageUsersMenue() {
		...
		cout << setw(37) << left << "" << "========================================\n";
		cout << setw(37) << left << "" << "\t\t Mnage Users Menue\n"; 
		cout << setw(37) << left << "" << "=========================================\n";
